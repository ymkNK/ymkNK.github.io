...
![导入项目代码全线飘红](http://lllovol.oss-cn-beijing.aliyuncs.com/assets/img/pics/WX20190807-102252@2x.png)
...
![设置maven settings](http://lllovol.oss-cn-beijing.aliyuncs.com/assets/img/pics/WX20190807-105505.png)
...
![](http://lllovol.oss-cn-beijing.aliyuncs.com/assets/img/pics/WX20190807-111529.png)

## 问题三：注解未开启
在安装好了 Lombok之后，发现运行还是报错
![](http://lllovol.oss-cn-beijing.aliyuncs.com/assets/img/pics/WX20190807-112144@2x.png)

### 解决方式
1. 关闭项目。 
2. Preference > Build, Execution, Deployment > Compiler > Annotation Processors. Check 'Enable annotation processing'. 
![](http://lllovol.oss-cn-beijing.aliyuncs.com/assets/img/pics/WX20190807-112533.png)
